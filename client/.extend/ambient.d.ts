 ...
 * 
 * Note that public dynamic environment variables must all be sent from the core to the client, causing larger network requests — when possible, use `$env/static/public` instead.
 * 
 * ```ts
